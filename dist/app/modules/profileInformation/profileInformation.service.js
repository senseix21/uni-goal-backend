...
exports.ProfileInformationService = void 0;
...
const create = (payload, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existingCartItem = yield prisma_1.prisma.profileInformation.findFirst({
        where: {
            userId,
        },
    });
    ...
    const result = yield prisma_1.prisma.profileInformation.create({
        data: Object.assign(Object.assign({}, payload), { userId })
    });
    return result;
});
const getSingle = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.prisma.profileInformation.findFirst({
        where: {
            userId
        },
        include: {
...
const updateSingle = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.prisma.profileInformation.update({
        where: {
            id: id
        },
        data: data
...
const deleteSingle = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.prisma.profileInformation.delete({
        where: {
            id: id
        }
    });
